...
public class InviteServiceImpl implements InviteService {
    ...
    @Override
    public void validateAndJoinBranch(String inviteEmail, Long inviteBranchId, String authenticatedEmail) {
    ...
    @Override
    public String generateInviteToken(String inviterEmail, String inviteeEmail, Long branchId) {
        // 초대자 이메일이 UserRepository에 존재하는지 확인
        if (userRepository.findIdByEmail(inviterEmail) == null) {
            throw new CustomException(ErrorCode.USER_NOT_FOUND);
        }
        return inviteToken.generateInviteToken(inviterEmail, inviteeEmail, branchId);
    }
}