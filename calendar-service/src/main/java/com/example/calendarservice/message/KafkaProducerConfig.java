...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ScheduleWorkedEventDTO> producerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers); // IP 적절히 변경
    ...
    @Bean
    public KafkaTemplate<String, ScheduleWorkedEventDTO> kafkaTemplate() {
